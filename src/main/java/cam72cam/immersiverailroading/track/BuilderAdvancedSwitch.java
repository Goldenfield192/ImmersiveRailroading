...
public class BuilderAdvancedSwitch extends BuilderBase implements IIterableTrack {

    private BuilderIterator turnBuilder1;
    private BuilderIterator turnBuilder2;
    private BuilderIterator turnBuilder3;
    ...
    public BuilderAdvancedSwitch(RailInfo info, World world, Vec3i pos) {
