...
public class Config {
	...
	public static class ImmersionConfig {
		...
		public static final boolean disableIndependentThrottle = true;

		@Comment("Old style brake control")
		@Name("Instant Brake Pressure")
		public static final boolean instantBrakePressure = false;

		@Comment("Enable coupler slack")
		public static final boolean slackEnabled = true;

        @Comment("Enable CARGO_FILL and CARGO_ITEMS load items dropped to the world")
        public static final boolean allowCargoLoadDroppedItem = true;
    }
	...
	public static class ConfigBalance {
		...
		public static final boolean canDieselEnginesOverheat = true;
	...
	public static class ConfigPerformance {
		...
		public static final boolean multithreadedStockLoading = true;

		@Comment("How many MB of memory to reserve for stock loading per thread, higher numbers = safer but slower")
		public static final int megabytesReservedPerStockLoadingThread = 1024;
	}
	...
	public static class ConfigDebug {
		...
		@Range(min = 10, max = 60)
		public static final int physicsFutureTicks = 10;

		@Comment("Does stock drops itself/components when player is in creative mode?")
		public static final boolean stockDropInCreativeMode = true;
	}
