...
public class ConfigGraphics {
	...
	public static final boolean particlesEnabled = true;

	@Comment( "Self explanatory" )
	public static final boolean trainsOnTheBrain = true;
	
	@Comment("What unit to display speed in (kmh, ms, mph)")
	public static final SpeedDisplayType speedUnit = SpeedDisplayType.kmh;

	@Comment("What unit to display pressure in (psi, kpa, bar)")
	public static final PressureDisplayType pressureUnit = PressureDisplayType.bar;

	@Comment("What unit to display temperature in (celcius, kelvin, farenheit)")
	public static final TemperatureDisplayType temperatureUnit = TemperatureDisplayType.celcius;

	@Comment("What unit to display locomotive power in (w, kw, ps (metric horsepower), horsepower (imperial horsepower))")
	public static final PowerDisplayType powerUnit = PowerDisplayType.kw;

	@Comment("What unit to display locomotive traction force in (kn, n, lbf)")
	public static final ForceDisplayType forceUnit = ForceDisplayType.kn;
	...
	public static final boolean RenderSemiTransparentParts = true;
	...
	public static final ScrollMode scrollMode = ScrollMode.ALL;
}
