	...
	public void commonEvent(ModEvent event) {
		...
		switch (event) {
			case CONSTRUCT:
				...
				Packet.register(MultiUnitGui.MultiUnitChangePacket::new, PacketDirection.ClientToServer);
				Packet.register(MultiUnitPlacePacket::new, PacketDirection.ClientToServer);
	...
	public void clientEvent(ModEvent event) {
		switch (event) {
			case CONSTRUCT:
				...
				ItemRender.register(IRItems.ITEM_MULTIPLE_UNIT, ObjItemRender.getModelFor(new Identifier(MODID, "models/item/wrench/wrench.obj"), new Vec3d(0.5, 0, 0.5), 2)); //TODO!
			...
			case SETUP:
				...
				MultiUnitDefinitionManager.load();
				break;
			case RELOAD:
				DefinitionManager.initDefinitions();
				break;
