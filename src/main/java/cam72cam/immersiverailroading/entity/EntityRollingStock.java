...
import cam72cam.immersiverailroading.model.animation.IAnimationProvider;
...
public class EntityRollingStock extends CustomEntity implements ITickable, IClickable, IKillable, IAnimationProvider {
	@TagField("defID")
